export function Footer() {
    return (
        <>
            <footer id="footer" className="h-full overflow-hidden sm:w-1/2 w-4/5 rounded-t-2xl justify-center dark:bg-neutral-950 bg-slate-300 flex bottom-0 gap-2 flex-row sm:px-8 py-5">
