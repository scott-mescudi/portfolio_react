        ...
        <div className='min-h-screen flex flex-col  items-center w-full'>  
            <div className='sm:w-1/2 w-4/5  h-fit flex 1xl:flex-row 2xl:flex-row flex-col gap-5'> 
                ...
                <div className='w-full justify-between  flex-col border border-white border-opacity-15 p-5 text-white rounded-xl'>
                    ...
                    <iframe 
                        className="rounded-md" 
                        src="https://open.spotify.com/embed/track/0qGZkkxnyfGrUBLflKwBQG?utm_source=generator"
                        width="100%" 
                        height="20%" 
                        allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" 
                        loading="lazy">
                    ...
                    <iframe 
                        className="rounded-md" 
                       src="https://open.spotify.com/embed/track/6PDlkWmrq2ZKiUuFt2aQsH?utm_source=generator" 
                        width="100%" 
                        height="20%" 
                        allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" 
                        loading="lazy">
                    ...
                    <iframe 
                        className="rounded-md" 
                        src="https://open.spotify.com/embed/track/3zi9xNpG2WHCdCAxV0BpJm?utm_source=generator"
                        width="100%" 
                        height="20%" 
                        allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" 
                        loading="lazy">
                    ...
                    <iframe 
                        className="rounded-md" 
                        src="https://open.spotify.com/embed/track/4DQttwipnILl88cru3BRZx?utm_source=generator"
                        width="100%" 
                        height="20%" 
                        allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" 
                        loading="lazy">
